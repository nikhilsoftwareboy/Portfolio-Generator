        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="md:col-span-1">
                <div class="bg-white rounded-lg shadow-md overflow-hidden card-custom mb-6">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mb-2"><span class="font-semibold">Email:</span> <?php echo htmlspecialchars($user["email"]); ?></p>
                        <p class="mb-4"><span class="font-semibold">Joined:</span> <?php echo date("F j, Y", strtotime($user["created_at"])); ?></p>
                        <a href="create-portfolio.php" class="block w-full text-center font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 btn-primary-custom">
            ...
            <div class="md:col-span-2">
                <div class="bg-white rounded-lg shadow-md overflow-hidden card-custom">
                    <div class="gradient-card-header py-4 px-6">
                        <h2 class="text-xl font-bold">My Portfolios</h2>
                    </div>
                    <div class="p-6">
                                ...
                                <?php foreach($portfolios as $portfolio): ?>
                                    <div class="border rounded-lg p-4 hover:bg-blue-50 transition duration-300 hover-card">
                                        <div class="flex justify-between items-start">
                                            ...
                                            <span class="text-sm text-gray-500">Created: <?php echo date("m/d/Y", strtotime($portfolio["created_at"])); ?></span>
                                        </div>
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="javascript:void(0);" onclick="confirmDelete(<?php echo $portfolio['id']; ?>)" class="bg-red-100 text-red-600 border border-red-200 hover:bg-red-200 px-3 py-1 rounded text-sm transition duration-300">Delete</a>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
