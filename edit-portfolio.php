            ...
            <div class="p-6">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=" . $portfolio_id; ?>" method="post">
                    ...
                    <div class="flex items-center justify-end mt-10">
                        <button type="submit" class="btn-primary-custom py-3 px-6 rounded-lg transition duration-300 flex items-center mr-3">
                            <i class="fas fa-save mr-2"></i> Update Portfolio
                        </button>
                        <a href="portfolio-template.php?id=<?php echo $portfolio_id; ?>" class="btn-secondary-custom py-3 px-6 rounded-lg transition duration-300 mr-3">
                            View Portfolio
                        </a>
                        <a href="profile.php" class="btn-secondary-custom py-3 px-6 rounded-lg transition duration-300">
                            Back to Profile
                        </a>
                    </div>
                </form>
